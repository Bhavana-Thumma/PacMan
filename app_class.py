...
#________________________________________ HELPER FUNCTIONS _______________________________________#
...
#_____________________________________ START FUNCTIONS _________________________________________#
...
#____________________________________ PLAYING FUNCTIONS ___________________________________________#
...
#_______________________________________ GAME OVER FUNCTIONS ________________________________________________#
    ...
    def game_over_draw(self):
        ...
        self.draw_text("Oh!..Game Over", self.screen, [WIDTH//2, 200],  52, RED, "times new roman", centered=True)
        self.draw_text(again_text, self.screen, [
                       WIDTH//2, HEIGHT//2],  36, (190, 190, 190), "times new roman", centered=True)
        self.draw_text(quit_text, self.screen, [
                       WIDTH//2, HEIGHT//1.5],  36, (190, 190, 190), "times new roman", centered=True)
        pygame.display.update()
